...
balltoball_df.to_csv(os.path.join(modeling,"data","filtered_data","balltoball.csv"), index=False)
...
team12_stats_df.to_csv(os.path.join(modeling,"data","filtered_data","team12_stats.csv"), index=False)
...
players_stats_df.to_csv(os.path.join(modeling,"data","filtered_data","players_stats.csv"), index=False)
