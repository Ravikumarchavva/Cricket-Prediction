...
def preprocess_batting_data(batting_data: DataFrame) -> DataFrame:
    logging.info("Starting preprocessing of batting data.")
    """
    ...
    logging.info("Finished preprocessing of batting data.")
    return batting_data

def preprocess_bowling_data(bowling_data: DataFrame) -> DataFrame:
    logging.info("Starting preprocessing of bowling data.")
    """
    ...
    logging.info("Finished preprocessing of bowling data.")
    return bowling_data

def preprocess_fielding_data(fielding_data: DataFrame) -> DataFrame:
    logging.info("Starting preprocessing of fielding data.")
    """
    ...
    logging.info("Finished preprocessing of fielding data.")
    return fielding_data

def map_country_codes(df: DataFrame, country_codes: Dict[str, str]) -> DataFrame:
    logging.info("Starting country code mapping.")
    """
    ...
    logging.info("Finished country code mapping.")
    return df